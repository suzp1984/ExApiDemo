...
public class ExApiDemoActivity extends AppCompatActivity {

    private static final String CUSTOME_CATEGORY = "suzp1984.github.io.exapidemo.samplecode";
    ...
    protected Intent browseIntent(String path) {
        Intent result = new Intent();
        result.setClass(this, ExApiDemoActivity.class);
